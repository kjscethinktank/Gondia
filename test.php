...
<div class="content">
            <div class="portlet light portlet-form">
                ...
                <div class="form-group form-md-line-input" >
                    ...
                    <div class="row">
                            <div class="form-group form-md-line-input" >
                                <label class="col-xs-1 col-sm-1 col-md-1 control-label" style="color:black;"><b>Name:</b>
                                </label>
                                <div class="col-xs-2 col-sm-2 col-md-2">
                                    <div class="input-group">
                                ...
                                <label class="col-xs-1 col-sm-1 col-md-1 control-label" style="color:black;"><b>DOA:</b>
                                </label>
                                <div class="col-xs-2 col-sm-2 col-md-2">
                                    <div class="input-group">
                                ...
                                <label class="col-xs-1 col-sm-1 col-md-1 control-label" style="color:black;"><b>Age:</b>
                                </label>
                                <div class="col-xs-2 col-sm-2 col-md-2">
                                    <div class="input-group">
                                ...
                                <label class="col-xs-1 col-sm-1 col-md-1 control-label" style="color:black;"><b>Gender:</b>
                                </label>
                                <div class="col-xs-2 col-sm-2 col-md-2">
                                <div class="input-group">
