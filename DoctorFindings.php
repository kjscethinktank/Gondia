     ...
     <script>
        function up(){
            ...
            if(dt!="" && ti!="" && fi!="" && tr!="")
                ...
                document.getElementById("earlier_treat").disabled=true;
                document.getElementById("conc").disabled=true;
                document.getElementById("conct").disabled=true;
        }

        function msgClose()
        {
                    document.getElementById("symptoms").disabled=false;
                    document.getElementById("earlier_treat").disabled=false;
...
<script type="text/javascript">
    ...
    $("#img_form").on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: 'DoctorFindingsUploadImage.php',
