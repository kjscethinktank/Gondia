        ...
        <div class="col-md-6 offset-md-3">
            <div class="card login">
                ...
                <div class="portlet-title">
                    ...
                    <div style="color:#ffc107">&nbsp; GONDIA CARE HOSPITAL</div></span></h2>
                </div>
                    ...
                    <form>
                        ...
                        <button type="button" class="btn btn-warning btn-lg btn-block text-white" onclick="window.location.href='Admitpatient.php'">Login</button>
                        <br>
