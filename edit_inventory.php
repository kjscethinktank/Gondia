...
<div class="content">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-5">
                                    ...
                                    <input type="textarea" class="form-control" placeholder="" name="price" >
                                    <div class="form-control-focus"> </div>
     ...
     <?php 
        ...
        if(isset($_POST["sub"])){
//        header('Location: Gondia/inventory.php');    
        $quant=$_POST["quant"];
        $price=$_POST["price"];
            ...
            if($res){
                ...
                $add= $add + $quant;
                if($price !=""){
                    $query1="Update inventory set available = '$add' , inven_cost = '$price' where inven_id='$id'";
                ...
                $query3 ="Insert into inventory_updatelog (Record,timestamp,equipment_name,Quantity) values ('',NOW(),'$name','$quant') ";
